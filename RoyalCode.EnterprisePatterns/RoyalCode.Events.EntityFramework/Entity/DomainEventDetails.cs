...
public class DomainEventDetails : Entity<Guid>
{
    ...
    public DomainEventDetails(IDomainEvent domainEvent)
    {
        ...
        Name = DomainEventNames.GetName(domainEvent.GetType());
...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Unique name of the event in the application domain.
    /// </summary>
    public string Name { get; }

    /// <summary>
    /// The fullname of the domain event type when generated.
    /// </summary>
