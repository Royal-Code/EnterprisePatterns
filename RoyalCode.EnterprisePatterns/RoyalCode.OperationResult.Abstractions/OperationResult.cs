...
public readonly struct OperationResult<TValue>
{
    ...
    /// <param name="error"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator OperationResult<TValue>(MessageCollection error) => new(error);
    ...
    private readonly TValue? value;
    private readonly MessageCollection? error;
    ...
    /// <param name="error">The error of the operation result.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public OperationResult(MessageCollection error)
    {
        value = default;
        this.error = error;
        Failure = true;
    ...
    /// <returns>Whether the operation result is failure.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool TryGetError([NotNullWhen(true)] out MessageCollection? error)
    {
        error = this.error;
        return Failure;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool TryConvertError<TOtherError>(
        Func<MessageCollection, TOtherError> converter,
        [NotNullWhen(true)] out TOtherError? error)
        where TOtherError : notnull
    {
        if (Failure)
    ...
    /// <returns>Whether the operation result is successful.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool IsSuccessOrGetError([NotNullWhen(false)] out MessageCollection? error)
    {
        error = this.error;
        return !Failure;
    }
    ...
    /// <returns>The new operation result.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly OperationResult<TOther, MessageCollection> Convert<TOther>(Func<TValue, TOther> map)
        => Failure ? error : map(value);
    ...
    /// <returns>The new operation result.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly OperationResult<TOther, MessageCollection> Convert<TOther, TParam>(
        Func<TValue, TParam, TOther> map,
        TParam param)
        => Failure ? error : map(value, param);
    ...
    /// <returns>The result of the executed function.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult Match<TResult>(Func<TValue, TResult> match, Func<MessageCollection, TResult> error)
        => Failure ? error(this.error) : match(value);
    ...
    public TResult Match<TResult, TParam>(
        Func<TValue, TParam, TResult> match,
        Func<MessageCollection, TParam, TResult> error,
        TParam param)
        => Failure ? error(this.error, param) : match(value, param);
